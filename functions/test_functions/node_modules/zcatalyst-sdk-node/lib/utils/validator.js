...
var validationError = require('./error').CatalystError;
var CatalystAppError = require('./error').CatalystAppError;
/**
...
function isURL(urlStr) {
    ...
    try {
        var schemeTest = /^(http|https):/;
        var uri = parse(urlStr);
...
function isNonEmptyObject(value, name, throwErr) {
    if (isNonNullObject(value, name, throwErr) && Object.keys(value).length !== 0) {
        return true;
    }
    if (throwErr) {
        throw new validationError({
