...
var CatalystAppInternals = /** @class */ (function () {
    ...
    CatalystAppInternals.prototype.isTicketBasedAuth = function () {
        ...
        if (this.credential.cachedTokenPromise && notExpired) {
            ...
            this.credential.cachedTokenPromise = this.credential.getAccessToken().then(function (result) {
                if (!isNonNullObject(result)) {
                    throw new CatalystAuthError('invalid_credential', 'Unknown result while retriving access token.');
                }
                var token;
                if (isNonEmptyString(result.ticket)) {
                    ...
                    throw new CatalystAuthError('invalid_credential', 'access_token could not be generated.');
                }
