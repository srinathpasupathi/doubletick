...
var CatalystNamespace = /** @class */ (function () {
    ...
    CatalystNamespace.prototype.initializeApp = function (options, projectName) {
        ...
        if (!isNonNullObject(options)) {
            ...
            if (!isNonEmpty(options)) {
                throw new CatalystAppError('invalid_app_options', 'Options provided for initializeApp in invalid.');
            }
        }
        ...
        switch (type) {
            case constants.INIT_TYPE.applogic:
                if (!object || typeof object.headers !== 'object') {
                    throw new CatalystAppError('invalid_app_object', 'the object passed to initialize method is not valid');
                }
            ...
            default:
                ...
                throw new CatalystAppError('invalid_app_object', 'unable to find the type of initialisation. kindly specify one');
        }
    ...
    CatalystNamespace.prototype.loadOptionsFromEnvVar = function () {
        ...
        try {
            ...
            throw new CatalystAppError('invalid_app_options', 'Failed to parse app options : ' + err);
        }
    };
    CatalystNamespace.prototype.app = function (projectName) {
        ...
        if (!isNonEmptyString(projectName)) {
            throw new CatalystAppError('invalid_app_name', 'Invalid app name provided. App name must be a non-empty string.');
        }
