...
var Cache = /** @class */ (function (_super) {
    ...
    Cache.prototype.segment = function (id) {
        ...
        if (!isStringOrNumber(segmentId)) {
            throw new CatalystCacheError('invalid-argument', 'Provided value segment_id must be a string or number');
        }
